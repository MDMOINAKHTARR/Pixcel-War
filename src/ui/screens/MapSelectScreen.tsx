...
import { ArrowLeft, ArrowRight, Check, Trophy, Flame } from 'lucide-react';
...
export const MapSelectScreen: React.FC<MapSelectScreenProps> = ({
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex flex-col justify-between p-4 md:p-8 bg-[#161224] relative overflow-hidden select-none animate-fadeIn">
      ...
      {/* Top Header matching Pixel Wheels Screenshot 5 */}
        ...
        <div className="bg-[#484064] border-4 border-[#2b2542] rounded-3xl p-4 md:p-6 shadow-[0_12px_24px_rgba(0,0,0,0.6)]">
          <div className="flex items-center justify-center gap-3 md:gap-6 overflow-x-auto py-2">
            ...
            <div
              ...
              className={`p-3 rounded-2xl cursor-pointer transition-all flex flex-col items-center ${
            ...
            >
              <DioramaCity />
              <span className="text-[8px] text-white pt-1">BLOCKY TOWN</span>
            </div>
            ...
            >
              <DioramaDesert />
              <span className="text-[8px] text-white pt-1">DESERT CANYON</span>
            </div>
            ...
            >
              <DioramaSnow />
              <span className="text-[8px] text-white pt-1">SNOWY PEAK</span>
            </div>

            {/* Diorama 4: Volcanic Canyon (NEW) */}
            <div
            ...
            >
              <DioramaVolcano />
              <span className="text-[8px] text-orange-400 font-bold pt-1 flex items-center gap-1">
                <Flame className="w-2.5 h-2.5" /> VOLCANIC CANYON
              </span>
            </div>
            ...
            >
              <DioramaIndustrial />
              <span className="text-[8px] text-white pt-1">INDUSTRIAL APEX</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#241f38] border-2 border-[#3d3261] rounded-3xl p-5 md:p-6 shadow-xl flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="space-y-2 text-center md:text-left">
            <div className="inline-block px-3 py-1 bg-[#9d3b76]/30 border border-[#d965a9] rounded-full text-[9px] text-[#f472b6] tracking-wider">
              {currentMap.difficulty} CIRCUIT
            </div>
            <h2 className="font-['Press_Start_2P',sans-serif] text-base md:text-lg text-white tracking-wide">
              {currentMap.name}
            </h2>
          ...
          {/* High Score Records / Best Lap Medals */}
          <div className="bg-[#1b152d] border border-[#3d3261] rounded-2xl p-4 min-w-[240px] space-y-2 font-mono text-xs">
            <div className="text-[9px] text-yellow-400 font-['Press_Start_2P',sans-serif] pb-1 border-b border-[#3d3261] flex items-center gap-1.5">
              <Trophy className="w-3.5 h-3.5" /> CIRCUIT RECORDS
            </div>
            <div className="flex items-center justify-between text-gray-300">
              <span className="flex items-center gap-1.5">🥇 1st Record</span>
              <span className="text-white font-bold">0:28.452</span>
            </div>
            <div className="flex items-center justify-between text-gray-300">
      ...
      <div className="flex items-center justify-between max-w-5xl mx-auto w-full z-10 pt-2 font-['Press_Start_2P',sans-serif]">
        {/* Left Arrow Button */}
        <button
          onClick={handlePrev}
